...
import { eventBus, EVENTS } from './background/eventBus'
...
app.on('activate', () => {
  ...
  if (!globalStore.win) {
    createWindow()
  } else if (globalStore.win.isMinimized()) {
    globalStore.win.restore()
  } else {
